...
<main>
 <svg
  ...
  <p id="errorText">Nội dung này hiện không tồn tại.</p>
  <a id="errorLink" href="<?php bloginfo('home');?>">Trang chủ</a>
</main>
<style>
  header,footer{display: none;}
main{height:100vh;width:100vw;background:#fff;display:flex;flex-direction:column;justify-content:center;align-items:center;}
main #errorText{font-size:22px;margin:14px 0}
main #errorLink{font-size:20px;padding:12px;border:1px solid;color:#000;background-color:transparent;text-decoration:none;transition:all .5s ease-in-out}
main #errorLink:hover,main #errorLink:active{color:#fff;background:#000}
main #g6219{transform-origin:85px 4px;-webkit-animation:an1 12s .5s infinite ease-out;animation:an1 12s .5s infinite ease-out}
