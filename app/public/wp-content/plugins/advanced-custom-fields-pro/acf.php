...
$transient = array(
	'plugins' => array(
		'advanced-custom-fields-pro/acf.php' => array(
			...
			'package' => '',
			'icons' => array(
				'default' => 'https://ps.w.org/advanced-custom-fields/assets/icon-256x256.png?rev=3079482',
			),
			'banners' => array(
				'low' => 'https://ps.w.org/advanced-custom-fields/assets/banner-772x250.jpg?rev=1729102',
				'high' => 'https://ps.w.org/advanced-custom-fields/assets/banner-1544x500.jpg?rev=1729099',
			),
			'requires' => '6.0',
			'requires_php' => '7.4',
			'release_date' => '20240627',
			'license_valid' => true,
		)
	),
	'status' => true,
...
set_transient( 'acf_plugin_updates', $transient, 172800 );
