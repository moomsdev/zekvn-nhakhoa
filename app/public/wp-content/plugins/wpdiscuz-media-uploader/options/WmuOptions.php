...
class WmuOptions implements WmuConstants {
	...
	public function __construct() {
		...
		add_action( "wpdiscuz_phrases", [ $this, "savePhrases" ] );
		add_action( "wpdiscuz_phrases_loaded", [ $this, "initPhrases" ] );
	}
	...
	public function savePhrases( $phrases ) {
		$defaults                              = $this->getDefaultPhrases();
		$phrases["wmuPhraseImageSizesError"]   = isset( $_POST["wmuPhraseImageSizesError"] ) ? sanitize_text_field( $_POST["wmuPhraseImageSizesError"] ) : sanitize_text_field( $defaults["wmuPhraseImageSizesError"] );
		$phrases["wmuPhraseMediaTabTitle"]     = isset( $_POST["wmuPhraseMediaTabTitle"] ) ? sanitize_text_field( $_POST["wmuPhraseMediaTabTitle"] ) : sanitize_text_field( $defaults["wmuPhraseMediaTabTitle"] );
		$phrases["wmuPhraseButtonMediaFilter"] = isset( $_POST["wmuPhraseButtonMediaFilter"] ) ? sanitize_text_field( $_POST["wmuPhraseButtonMediaFilter"] ) : sanitize_text_field( $defaults["wmuPhraseButtonMediaFilter"] );
	...
	public function initPhrases( $phrases ) {
		$defaults                                       = $this->getDefaultPhrases();
		$this->wmuPhrases["wmuPhraseImageSizesError"]   = isset( $phrases["wmuPhraseImageSizesError"] ) ? $phrases["wmuPhraseImageSizesError"] : $defaults["wmuPhraseImageSizesError"];
		$this->wmuPhrases["wmuPhraseMediaTabTitle"]     = isset( $phrases["wmuPhraseMediaTabTitle"] ) ? $phrases["wmuPhraseMediaTabTitle"] : $defaults["wmuPhraseMediaTabTitle"];
		$this->wmuPhrases["wmuPhraseButtonMediaFilter"] = isset( $phrases["wmuPhraseButtonMediaFilter"] ) ? $phrases["wmuPhraseButtonMediaFilter"] : $defaults["wmuPhraseButtonMediaFilter"];
	}
	...
	private function getDefaultPhrases() {
		$phrases = [
			...
			"wmuPhraseButtonMediaFilter" => __( "Comments with attachments", "wpdiscuz-media-uploader" ),
		];
