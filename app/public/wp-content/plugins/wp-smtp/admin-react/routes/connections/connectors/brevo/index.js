				...
				<StyledSurfaceHeader>
					...
					<Text>
						{createInterpolateElement(
							__(
								'Brevo offers flexible pricing for email marketing. For pricing information <pricing>visit here</pricing>. For configuration information, <help>visit here</help>. ',
								'LION'
							),
							{
								pricing: (
									...
									<a
										href="https://go.solidwp.com/mail-brevo-pricing"
										rel="noreferrer"
										target="_blank"
									/>
								),
								help: (
									// eslint-disable-next-line jsx-a11y/anchor-has-content
									<a
										href="https://go.solidwp.com/mail-brevo-config"
										rel="noreferrer"
										target="_blank"
									/>
								),
