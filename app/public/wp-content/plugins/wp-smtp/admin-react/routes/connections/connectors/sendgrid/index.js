				...
				<StyledSurfaceHeader>
					...
					<Text>
						{createInterpolateElement(
							__(
								'SendGrid is a comprehensive email delivery platform offering robust APIs for sending, receiving, and tracking emails. For pricing information <pricing>visit here</pricing>. For configuration information, <help>visit here</help>.',
								'LION'
							),
							{
								pricing: (
									...
									<a
										href="https://go.solidwp.com/mail-sendgrid-pricing"
										rel="noreferrer"
										target="_blank"
									/>
								),
								help: (
									// eslint-disable-next-line jsx-a11y/anchor-has-content
									<a
										href="https://go.solidwp.com/mail-sendgrid-config"
										rel="noreferrer"
										target="_blank"
									/>
								),
