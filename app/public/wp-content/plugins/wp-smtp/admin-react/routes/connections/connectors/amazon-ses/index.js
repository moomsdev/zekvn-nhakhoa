				...
				<StyledSurfaceHeader>
					...
					<Text>
						{createInterpolateElement(
							__(
								'Amazon SES (Simple Email Service) is a scalable, cost-effective email service for developers and businesses. It supports sending transactional, marketing, and bulk emails with a pay-as-you-go pricing model. For pricing information <pricing>visit here</pricing>. For configuration information, <help>visit here</help>.',
								'LION'
							),
							{
								pricing: (
									...
									<a
										href="https://go.solidwp.com/mail-ses-pricing"
										rel="noreferrer"
										target="_blank"
									/>
								),
								help: (
									// eslint-disable-next-line jsx-a11y/anchor-has-content
									<a
										href="https://go.solidwp.com/mail-ses-config"
										rel="noreferrer"
										target="_blank"
									/>
								),
